...
export class AudioAnalyzer {
  ...
  update() {
    ...
    const bassLo = Math.max(20, this.bassCenter - 15);
    const bassHi = this.bassCenter + 15;
    ...
    const bassBarLo = Math.max(1, Math.floor((this.bassCenter - 15) / binHz));
    const bassBarHi = Math.min(this.dataArray.length - 1, Math.floor((this.bassCenter + 15) / binHz));
    let bassBarSum = 0;
